...
var CustomHeader = (function (_super) {
    __extends(CustomHeader, _super);
    function CustomHeader(props) {
        var _this = _super.call(this, props) || this;
        var schedulerData = new Scheduler_1.SchedulerData(ExampleFunction.updateSchedulerDataState.bind(_this), ExampleFunction.getNow(), Scheduler_1.SchedulerViewTypes.Week);
