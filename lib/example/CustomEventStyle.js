...
var CustomEventStyle = (function (_super) {
    __extends(CustomEventStyle, _super);
    function CustomEventStyle(props) {
        ...
        var schedulerData = new Scheduler_1.SchedulerData(ExampleFunction.updateSchedulerDataState.bind(_this), ExampleFunction.getNow(), Scheduler_1.SchedulerViewTypes.Week, false, false, {
            views: [
                { viewName: 'Week', viewType: Scheduler_1.SchedulerViewTypes.Week, showAgenda: false, isEventPerspective: false },
                {
                ...
                { viewName: 'Year', viewType: Scheduler_1.SchedulerViewTypes.Year, showAgenda: false, isEventPerspective: false },
            ],
        });
        schedulerData.setResources(DemoData_1.DemoData.resources);
        schedulerData.setEvents(DemoData_1.DemoData.eventsForCustomEventStyle);
        _this.state = {
            viewModel: schedulerData,
        };
        return _this;
    }
    CustomEventStyle.prototype.render = function () {
        var viewModel = this.state.viewModel;
        return (React.createElement("div", null,
            React.createElement(Nav_1.default, null),
            React.createElement("div", null,
                React.createElement("h3", { style: { textAlign: 'center' } }, "Custom event style"),
                React.createElement(Scheduler_1.default, { schedulerData: viewModel, EventFC: EventPlugin_1.EventComponent, prevClick: ExampleFunction.prevClick.bind(this), nextClick: ExampleFunction.nextClick.bind(this), onSelectDate: ExampleFunction.onSelectDate.bind(this), onViewChange: ExampleFunction.onViewChange.bind(this), updateEventStart: ExampleFunction.updateEventStart.bind(this), updateEventEnd: ExampleFunction.updateEventEnd.bind(this), moveEvent: ExampleFunction.moveEvent.bind(this), newEvent: ExampleFunction.newEvent.bind(this), newStock: ExampleFunction.newStock.bind(this), onScrollLeft: ExampleFunction.onScrollLeft.bind(this), onScrollRight: ExampleFunction.onScrollRight.bind(this), onScrollTop: ExampleFunction.onScrollTop.bind(this) }))));
    };
    return CustomEventStyle;
}(react_1.Component));
exports.default = withDnDContext_1.default(CustomEventStyle);
//# sourceMappingURL=CustomEventStyle.js.map