...
var Scheduler = (function (_super) {
    ...
    Scheduler.prototype.render = function () {
        ...
        var currentYear = Number(schedulerData.startDate.format('Y'));
            ...
            schedulerHeader = (React.createElement(React.Fragment, null,
                ...
                React.createElement(row_1.default, { type: 'flex', align: 'middle', justify: 'space-between', style: {
                    ...
                    React.createElement(col_1.default, { style: { width: '100%', display: 'flex' } },
                        React.createElement("div", { className: 'header2-text', style: { width: '100%', display: 'flex' }, onClick: this.goBack },
                            React.createElement("div", { style: { width: 'calc(100% / 3)', textAlign: 'left' } },
                            ...
                            React.createElement("div", { style: { width: 'calc(100% / 3)', textAlign: 'right' }, onClick: this.goNext },
                                currentYear + 1,
