    ...
    Scheduler.prototype.render = function () {
        ...
        if (showAgenda) {
            ...
            tbodyContent = (React.createElement("tr", null,
                React.createElement("td", { style: { width: resourceTableWidth, verticalAlign: 'top', backgroundColor: config.baseColor } },
                ...
                React.createElement("td", { style: { height: '100%', backgroundColor: config.baseColor } },
        ...
        var currentYear = schedulerData.startDate.format('Y');
        var nextYear = moment(currentYear + '-01-01')
            .add(1, 'year')
            .format('Y');
        var prevYear = moment(currentYear + '-01-01')
            .add(-1, 'year')
            .format('Y');
        var schedulerHeader = React.createElement("div", null);
        if (config.headerEnabled) {
            schedulerHeader = (React.createElement(React.Fragment, null,
                React.createElement(row_1.default, { type: 'flex', align: 'middle', justify: 'space-between', style: { marginBottom: '24px' } },
                    leftCustomHeader,
                    ...
                    rightCustomHeader),
                React.createElement(row_1.default, { type: 'flex', align: 'middle', justify: 'space-between', style: {
                        marginBottom: '24px',
                    ...
                    leftCustomHeader,
                    React.createElement(col_1.default, { style: { width: '100%', display: 'flex' } },
                        React.createElement("div", { className: 'header2-text', style: { width: 'calc(100% / 3)' }, onClick: this.goBack },
                            React.createElement("div", { style: { textAlign: 'left' } },
                                React.createElement(icon_1.default, { type: 'left', className: 'icon-nav', style: { marginRight: '8px' } }),
                                prevYear)),
                        React.createElement("div", { style: { width: 'calc(100% / 3)', textAlign: 'center' } }, calendarPopoverEnabled ? (React.createElement(popover_1.default, { content: popover, placement: 'bottom', trigger: 'click', visible: this.state.visible, onVisibleChange: this.handleVisibleChange },
                        ...
                        React.createElement("div", { className: 'header2-text', style: { width: 'calc(100% / 3)' }, onClick: this.goNext },
                            React.createElement("div", { style: { textAlign: 'right' } },
                                nextYear,
                                React.createElement(icon_1.default, { type: 'right', className: 'icon-nav', style: { marginLeft: '8px' } })))),
                    rightCustomHeader)));
        }
