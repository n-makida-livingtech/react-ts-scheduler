...
exports.getDateLabel = function (schedulerData, viewType, startDate, endDate) {
    ...
    if (viewType === ViewTypes_1.ViewTypes.Week || (start != end && (viewType === ViewTypes_1.ViewTypes.Custom || viewType === ViewTypes_1.ViewTypes.Custom1 || viewType === ViewTypes_1.ViewTypes.Custom2))) {
