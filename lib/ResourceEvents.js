...
var ResourceEvents = (function (_super) {
  ...
  function ResourceEvents(props) {
    ...
    _this.stopDrag = function (ev) {
      ev.stopPropagation();
      var _a = _this.props,
        schedulerData = _a.schedulerData,
        newEvent = _a.newEvent,
        newStock = _a.newStock,
        resourceEvents = _a.resourceEvents;
      var headers = schedulerData.headers,
        events = schedulerData.events,
        config = schedulerData.config,
        cellUnit = schedulerData.cellUnit;
      var _b = _this.state,
        leftIndex = _b.leftIndex,
        rightIndex = _b.rightIndex;
      if (supportTouch) {
    ...
    _this.onAddMoreClick = function (headerItem) {
      var _a = _this.props,
        onSetAddMoreState = _a.onSetAddMoreState,
        resourceEvents = _a.resourceEvents,
        schedulerData = _a.schedulerData;
  ...
  ResourceEvents.prototype.render = function () {
    ...
    var selectedArea = isSelecting
      ? React.createElement(SelectedArea_1.default, __assign({}, this.props, { left: left, width: width }))
      : React.createElement('div', null);
    var eventList = [];
    resourceEvents.headerItems.forEach(function (headerItem, index) {
      if (headerItem.count > 0 || headerItem.summary != undefined) {
        var isTop =
          config.summaryPos === SummaryPos_1.SummaryPos.TopRight ||
        ...
        headerItem.events.forEach(function (evt, idx) {
          if (idx < renderEventsMaxIndex_1 && evt !== undefined && evt.render) {
            ...
            var eventItem = React.createElement(
              DnDEventItem,
        ...
        if (headerItem.summary != undefined) {
          ...
          var summary = React.createElement(Summary_1.default, {
            key: key,
            schedulerData: schedulerData,
