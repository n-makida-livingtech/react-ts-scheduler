...
var ResourceEvents = (function (_super) {
    ...
    function ResourceEvents(props) {
        ...
        _this.stopDrag = function (ev) {
            ...
            var basicStock = resourceEvents.basicStock;
            ...
            if (hasConflict) {
                ...
                if (newEvent != undefined) {
                    newStock({ schedulerData: schedulerData, slotId: slotId, slotName: slotName, start: start, end: endTime, stock: basicStock });
                }
            }
        };
    ...
    ResourceEvents.prototype.render = function () {
        ...
        return (React.createElement("tr", { style: { height: '20px' } },
            React.createElement("td", { style: { width: rowWidth, height: '20px', boxSizing: 'border-box' } }, connectDropTarget(React.createElement("div", { ref: this.eventContainerRef, className: 'event-container', style: { height: resourceEvents.rowHeight + 1 } },
                selectedArea,
                eventList)))));
    };
