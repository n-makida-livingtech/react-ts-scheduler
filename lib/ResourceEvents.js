...
var ResourceEvents = (function (_super) {
    ...
    ResourceEvents.prototype.render = function () {
        ...
        return (React.createElement("tr", { style: { height: '20px' } },
            React.createElement("td", { style: { width: rowWidth, height: '20px', boxSizing: 'border-box' } }, connectDropTarget(React.createElement("div", { ref: this.eventContainerRef, className: 'event-container', style: { height: resourceEvents.rowHeight } },
                selectedArea,
                eventList)))));
    };
