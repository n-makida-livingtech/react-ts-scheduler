...
import Scheduler, { SchedulerData, SchedulerViewTypes, SummaryPos } from '../src/Scheduler';
...
class Summary extends Component<{}, { viewModel: SchedulerData }> {
  ...
  public changeSummaryPos = () => {
    ...
    schedulerData.config.summaryPos =
      schedulerData.config.summaryPos === SummaryPos.TopRight ? SummaryPos.BottomRight : SummaryPos.TopRight;
    this.setState({
      viewModel: schedulerData,
    });
  };
