...
import Scheduler, { SchedulerData, SchedulerViewTypes, SchedulerHeader } from '../src/Scheduler';
...
class Locale extends Component<
  {},
  { viewModel: SchedulerData; headerItem: SchedulerHeader; left: number; top: number; height: number }
> {
