...
export function updateEventStart(args: UpdateEventStartArgs) {
  if (
    confirm(
      `Do you want to adjust the start of the event? {eventId: ${args.event.id}, eventTitle: ${
        args.event.title
      }, newStart: ${args.newStart.format()}}`
    )
  ) {
...
export function updateEventEnd(args: UpdateEventEndArgs) {
  if (
    confirm(
      `Do you want to adjust the end of the event? {eventId: ${args.event.id}, eventTitle: ${
        args.event.title
      }, newEnd: ${args.newEnd.format()}}`
    )
  ) {
...
export function moveEvent(args: MoveEventArgs) {
  if (
    confirm(
      `Do you want to move the event? {eventId: ${args.event.id}, eventTitle: ${args.event.title}, newSlotId: ${
        args.slotId
      }, newSlotName: ${args.slotName}, newStart: ${args.start.format()}, newEnd: ${args.end.format()}`
    )
  ) {
