...
import { EventItemPopoverProps } from '../../src/';
...
export const PopoverComponent: React.FC<EventItemPopoverProps> = (props) => {
  ...
  return (
    <Popover
        ...
        <div style={{ width: '300px' }}>
          <Row type='flex' align='middle'>
            ...
            <Col span={22} className='overflow-text'>
              <span className='header2-text' title={props.title}>
                {props.title}
              </span>
            </Col>
          </Row>
          <Row type='flex' align='middle'>
            ...
            <Col span={22}>
              <span className='header1-text'>
                {startTime.format(DEMO_DATE_FORMAT)} - {endTime.format(DEMO_DATE_FORMAT)}
              </span>
            </Col>
          </Row>
          <Row type='flex' align='middle'>
            ...
            <Col span={22}>
              <Button
                onClick={() => {
                  alert(`You just clicked demo button. event title: ${props.eventItem.title}`);
                }}>
                Demo
              </Button>
            </Col>
      ...
      trigger='hover'>
      {props.connectDragPreview && connectDragPreview(connectDragSource(timelineEvent))}
    </Popover>
  );
};
